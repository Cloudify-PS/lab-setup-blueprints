...
cfy deployments create -b "kubernetes-bp"  kubernetes -i public_subnet_cidr=10.1.18.0/24 -i external_network_id=2a68ccf6-6722-42f0-a300-de647e55be28 -i region_name=RegionOne -i image_id=0847a4c0-99bf-4cb7-9cec-b019eb2fae99 -i flavor_id=3 >> /tmp/lab_status.txt 2>&1
